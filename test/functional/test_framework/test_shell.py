#!/usr/bin/env python3
# Copyright (c) 2019 The Garikcoin Core developers
...
class TestShell:
    """Wrapper Class for GarikcoinTestFramework.

    The TestShell class extends the GarikcoinTestFramework
    ...
    class __TestShell(GarikcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by GarikcoinTestFramework child class.
            self.num_nodes = 1
