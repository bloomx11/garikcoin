#!/usr/bin/env python3
# Copyright (c) 2020-2021 The Garikcoin Core developers
...
from test_framework.test_framework import GarikcoinTestFramework, SkipTest
...
class BindPortExternalIPTest(GarikcoinTestFramework):
