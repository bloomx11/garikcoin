#!/usr/bin/env python3
# Copyright (c) 2017-2021 The Garikcoin Core developers
...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the GarikcoinTestFramework
    pass


class ExampleTest(GarikcoinTestFramework):
    # Each functional test is a subclass of the GarikcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        GarikcoinTestFramework class so other tests can use it."""
