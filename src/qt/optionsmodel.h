...
/** Interface from Qt to configuration data structure for Garikcoin client.
...
public:
    ...
    GarikcoinUnit getDisplayUnit() const { return m_display_bitcoin_unit; }
...
private:
    ...
    QString language;
    GarikcoinUnit m_display_bitcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(GarikcoinUnit unit);
