    ...
    mapper(nullptr)
{
    ...
    ui->openGarikcoinConfButton->setToolTip(ui->openGarikcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new GarikcoinUnits(this));
...
void OptionsDialog::on_openGarikcoinConfButton_clicked()
{
