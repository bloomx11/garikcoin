...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, GarikcoinUnits::SeparatorStyle separators=GarikcoinUnits::SeparatorStyle::STANDARD) const;
