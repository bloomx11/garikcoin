...
{
    // Windows: C:\Users\Username\AppData\Roaming\Garikcoin
    // macOS: ~/Library/Application Support/Garikcoin
    // Unix-like: ~/.bitcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Garikcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Garikcoin";
#else
    // Unix-like
