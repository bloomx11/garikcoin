...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Garikcoin Core copyright is not removed by accident
    if (copyright_devs.find("Garikcoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Garikcoin Core developers";
    }
