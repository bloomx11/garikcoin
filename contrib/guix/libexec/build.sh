#!/usr/bin/env bash
# Copyright (c) 2019-2021 The Garikcoin Core developers
...
(
    ...
    # Setup the directory where our Garikcoin Core build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
    # Install built Garikcoin Core to $INSTALLPATH
    case "$HOST" in
        *darwin*)
