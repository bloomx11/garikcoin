...
Tracing (USDT) support for Garikcoin Core on Linux using. For more information on
USDT support in Garikcoin Core see the [USDT documentation].
...
[Garikcoin Core USDT documentation] on how to list available tracepoints in your
`bitcoind` binary.

[Garikcoin Core USDT documentation]: ../../doc/tracing.md#listing-available-tracepoints
...
In a different terminal, starting Garikcoin Core in SigNet mode and with
re-indexing enabled.
