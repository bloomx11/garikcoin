# PSBT Howto for Garikcoin Core

Since Garikcoin Core 0.17, an RPC interface exists for Partially Signed Garikcoin
...
PSBT is an interchange format for Garikcoin transactions that are not fully signed
...
#### Multisig with multiple Garikcoin Core instances
...
Garikcoin Core. We assume their wallets only contain the multisig funds. In case
