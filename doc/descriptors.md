# Support for Output Descriptors in Garikcoin Core

Since Garikcoin Core v0.17, there is support for Output Descriptors. This is a
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a Garikcoin Core descriptor wallet to serve as your
...
existing Garikcoin Core wallets, a convenience function `combo` is
...
All RPCs in Garikcoin Core will include the checksum in their output. Only
