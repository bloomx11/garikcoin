...
Garikcoin Core version 0.20.0 is now available from:
...
#### Removal of BIP61 reject network messages from Garikcoin Core

The `-enablebip61` command line option to enable BIP61 has been removed.
(#17004)

This feature has been disabled by default since Garikcoin Core version 0.18.0.
...
- OpenSSL is no longer used by Garikcoin Core.  (#17265)

- BIP70 support has been fully removed from Garikcoin Core. The
...
- All custom settings configured when Garikcoin Core starts are now
...
- The "Start Garikcoin Core on system login" option has been removed on macOS.
  (#17567)
...
- A "known bug" [announced](https://bitcoincore.org/en/releases/0.18.0/#wallet-gui)
  ...
  affected anyone who simultaneously used multiple Garikcoin Core wallets
...
- Garikcoin Core's automatically-generated source code documentation is
...
- #16983 Add detailed info about Garikcoin Core files (hebasto)
