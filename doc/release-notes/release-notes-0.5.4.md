Garikcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Garikcoin/bitcoin-0.5.4/
...
Fix Garikcoin-Qt notifications under Growl 1.3.
Increase required age of Garikcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGarikcoin properly when installing Garikcoin-Qt over it. (Windows)
