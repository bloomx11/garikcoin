Garikcoin-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/bitcoin/files/Garikcoin/bitcoin-0.8.6/
...
- Fix Garikcoin-Qt startup crash when clicking dock icon on OSX 
