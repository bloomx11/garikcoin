...
Below are some notes on how to build Garikcoin Core for Windows.

The options known to work for building Garikcoin Core on Windows are:
...
Note that for WSL the Garikcoin Core source path MUST be somewhere in the default mount file system, for
