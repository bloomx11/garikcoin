...
The Garikcoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Garikcoin Core requires the ZeroMQ API >= 4.0.0
...
using. Garikcoind appends an up-counting sequence number to each
