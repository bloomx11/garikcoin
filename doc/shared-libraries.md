...
The purpose of this library is to make the verification functionality that is critical to Garikcoin's consensus available to other applications, e.g. to language bindings.
...
- [NGarikcoin](https://github.com/MetacoSA/NGarikcoin/blob/5e1055cd7c4186dee4227c344af8892aea54faec/NGarikcoin/Script.cs#L979-#L1031) (.NET Bindings)
