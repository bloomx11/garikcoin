...
The data directory is the default location where the Garikcoin Core files are stored.
...
These subdirectories and files are no longer used by Garikcoin Core:
